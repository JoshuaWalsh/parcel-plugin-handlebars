...
class HbsAsset extends HTMLAsset {
  ...
  constructor(name, pkg, options) {
    ...
    this.wax = handlebarsWax(handlebars)
      .helpers(this.resolveDependencies(config.helpers))
      .data(this.resolveDependencies(config.data))
      .decorators(this.resolveDependencies(config.decorators))
      .partials(this.resolveDependencies(config.partials));
  }
